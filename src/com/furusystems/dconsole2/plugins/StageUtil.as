...
//		_console.createCommand( "alignStage", alignStage, "Stage", "Sets stage.align to TOP_LEFT and stage.scaleMode to NO_SCALE" );
		...
		_console.createCommand( "fs", toggleFullscreen, "FullscreenUtil", "Toggles stage.displayState between FULL_SCREEN and NORMAL" );
	}
	...
	private function toggleFullscreen():void {
		switch ( _console.view.stage.displayState ) {
			...
			case StageDisplayState.NORMAL:
				_console.view.stage.displayState = StageDisplayState.FULL_SCREEN_INTERACTIVE;
				break;
		}
	}
