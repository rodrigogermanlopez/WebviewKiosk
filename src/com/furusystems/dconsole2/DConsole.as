...
public class DConsole extends DSprite implements IConsole {
	...
	public function DConsole() {
		...
		print( "Welcome to the console", ConsoleMessageTypes.SYSTEM );
	...
	private function setupDefaultCommands():void {
		...
		createCommand( "cmd", _commandManager.listCmd, "Utility", "Output a list of available commands. Add a second argument to search." );
...
//		trace("search term:", term, idx ) ;
	...
	public function createCommand( triggerPhrase:String, func:Function, commandGroup:String = "Application",
	...
	public function printTo( targetLog:String, str:String, type:String = ConsoleMessageTypes.INFO,
							 tag:String = "" ):void {
	...
	private function onAddedToStage( e:Event ):void {
		...
		view.setHeaderText( "CONSOLE " + Version.Major + "." + Version.Minor );
	...
	private function doSearch( searchString:String, includeAccessors:Boolean = false, includeCommands:Boolean = true,
							   includeScopeMethods:Boolean = false ):Vector.<String> {
	 ...
	 */
	public static function createCommand( triggerPhrase:String, func:Function, category:String = "Application",
										  helpText:String = "" ):void {
